...
public class TrackErrorFixer implements MediaSourceEventListener {
    ...
    // if (error != null && error.getCause() instanceof
    // DecoderInitializationException) {
    // return
    // selectDifferentCodec(MimeTypes.isAudio(((DecoderInitializationException)
    // error.getCause()).mimeType));
    // }
    //
    // return false;
    // }
    ...
    private boolean selectDifferentCodec(boolean isAudio) {
        ...
        Set<MediaTrack> tracks = isAudio ? mTrackSelectorManager.getAudioTracks()
                : mTrackSelectorManager.getVideoTracks();
    ...
    // }
    //
    // Set<MediaTrack> tracks = isAudio(mLastEx) ?
    // mTrackSelectorManager.getAudioTracks() :
    // mTrackSelectorManager.getVideoTracks();
    //
    // if (tracks == null) {
    // return false;
